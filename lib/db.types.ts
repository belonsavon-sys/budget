...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      recurring_rules: {
        Row: { account_id: string; active: boolean; amount: number; autopay: boolean; category_id: string | null; created_at: string; currency: string; day_of_month: number | null; deleted_at: string | null; end_balance: number | null; end_count: number | null; end_date: string | null; frequency: string; household_id: string; id: string; last_generated: string | null; name: string; notes: string | null; start_date: string; tag_ids: Json; to_account_id: string | null; type: string; updated_at: string }
